...
<script>
  export default {
    data() {
      return {
        ...
        headers: [
          ...
          {text: '操作备注', value: 'remark'},
          {text: '操作时间', value: 'createTime'},
          {text: '操作IP', value: 'ip'},
          {text: '操作用户', value: 'createUser'},
        ],
        items: [],
        search: '',
        selected: [],
    ...
    methods: {
      ...
      getOperationList() {
        localStorage.setItem(`operationLogList`, JSON.stringify([
          {
            id: '1',
            name: 'Create User',
            remark: '',
          ...
          },
          {
            ...
            name: 'Create User',
            remark: '',
            createTime: '2018-01-01 16:40:30',
            ip: '192.168.1.1',
            createUser: '李白',
          },
        ]));
        this.items = JSON.parse(localStorage.getItem('operationLogList')) === null ? [] : JSON.parse(localStorage.getItem('operationLogList'))
      },
      delete() {
